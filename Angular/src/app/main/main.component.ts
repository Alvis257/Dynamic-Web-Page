...
const ELEMENT_DATA: DataStructure[] = [
  ...
  { id: 2, name: 'Item 2', status: 'Inactive', creationTime: new Date('2022-01-02'), responsible: 'Jane Doe', type: 'first-form'},
  { id: 3, name: 'Item 3', status: 'Active', creationTime: new Date('2022-01-03'), responsible: 'John Smith', type: 'first-form'},
  { id: 4, name: 'Item 4', status: 'Inactive', creationTime: new Date('2022-01-04'), responsible: 'Jane Smith', type: 'first-form'},
  { id: 5, name: 'Item 5', status: 'Active', creationTime: new Date('2022-01-05'), responsible: 'John Johnson', type: 'first-form'},
  { id: 6, name: 'Item 6', status: 'Inactive', creationTime: new Date('2022-01-06'), responsible: 'Jane Johnson', type: 'first-form'},
  { id: 7, name: 'Item 7', status: 'Active', creationTime: new Date('2022-01-07'), responsible: 'John Williams', type: 'first-form' },
  { id: 8, name: 'Item 8', status: 'Inactive', creationTime: new Date('2022-01-08'), responsible: 'Jane Williams', type: 'first-form' },
  { id: 9, name: 'Item 9', status: 'Active', creationTime: new Date('2022-01-09'), responsible: 'John Brown', type: 'first-form'},
  { id: 10, name: 'Item 10', status: 'Inactive', creationTime: new Date('2022-01-10'), responsible: 'Jane Brown', type: 'first-form' }
];
